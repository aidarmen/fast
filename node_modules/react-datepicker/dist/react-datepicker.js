! function (e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports, require("react"), require("prop-types"), require("classnames"), require("react-onclickoutside"), require("moment"), require("react-popper")) : "function" == typeof define && define.amd ? define(["exports", "react", "prop-types", "classnames", "react-onclickoutside", "moment", "react-popper"], t) : t(e.DatePicker = {}, e.React, e.PropTypes, e.classNames, e.onClickOutside, e.moment, e.ReactPopper)
    ...
    function h(e) {
        return null == e ? d() : function (e) {
            return a().utc().utcOffset(e)
        }(e)
    }
    ...
    function V(e, t) {
        ...
        var o = a().hours(0).minutes(0).seconds(0),
            s = o.clone().hours(e.get("hours")).minutes(e.get("minutes")),
            i = o.clone().hours(n.get("hours")).minutes(n.get("minutes")),
            p = o.clone().hours(r.get("hours")).minutes(r.get("minutes"));
    ...
    function L(e) {
        var t = e.minDate,
            n = e.includeDates;
        return n && t ? a.min(n.filter(function (e) {
    ...
    function A(e) {
        var t = e.maxDate,
            n = e.includeDates;
        return n && t ? a.max(n.filter(function (e) {
            return t.isSameOrAfter(e, "day")
        })) : n ? a.max(n) : t
    }

    function H() {
        for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "react-datepicker__day--highlighted", n = new Map, r = 0, o = e.length; o > r; r++) {
            var a = e[r];
            if (f(a)) {
                var s = a.format("MM.DD.YYYY"),
                    i = n.get(s) || [];
                i.includes(t) || (i.push(t), n.set(s, i))
            } else if ("object" === (void 0 === a ? "undefined" : z(a))) {
                var p = Object.keys(a),
                    c = p[0],
                    l = a[p[0]];
    ...
    t = t && t.hasOwnProperty("default") ? t.default : t, n = n && n.hasOwnProperty("default") ? n.default : n, r = r && r.hasOwnProperty("default") ? r.default : r, o = o && o.hasOwnProperty("default") ? o.default : o, a = a && a.hasOwnProperty("default") ? a.default : a;
                ...
                o.renderOptions = function () {
                    var e = o.props.year,
                        n = o.state.yearsList.map(function (n) {
                            return t.createElement("div", {
                                className: e === n ? "react-datepicker__year-option --selected_year" : "react-datepicker__year-option",
                                key: n,
                                ref: n,
                                onClick: o.onChange.bind(o, n)
                            }, e === n ? t.createElement("span", {
                ...
                return o.state = {
                    yearsList: function (e, t, n, r) {
                        for (var o = [], a = 0; 2 * t + 1 > a; a++) {
                            var s = e + t - a,
                                i = !0;
                            n && (i = n.year() <= s), r && i && (i = r.year() >= s), i && o.push(s)
                        }
                        return o
                    }(o.props.year, r.yearDropdownItemNumber || (r.scrollableYearDropdown ? 10 : 5), o.props.minDate, o.props.maxDate)
                }, o
            }
    ...
    var Z = {
        ...
        ee = function (e) {
            function n() {
                var r, o, a;
                U(this, n);
                for (var s = arguments.length, i = Array(s), p = 0; s > p; p++) i[p] = arguments[p];
                return r = o = Q(this, e.call.apply(e, [this].concat(i))), o.state = {
                    dropdownVisible: !1
                }, o.renderSelectOptions = function () {
                    for (var e = o.props.minDate ? C(o.props.minDate) : 1900, n = o.props.maxDate ? C(o.props.maxDate) : 2100, r = [], a = e; n >= a; a++) r.push(t.createElement("option", {
                        key: a,
                        value: a
                    }, a));
                    return r
    ...
    var te = function (e) {
        function n() {
            ...
            U(this, n);
            for (var s = arguments.length, i = Array(s), p = 0; s > p; p++) i[p] = arguments[p];
            return r = o = Q(this, e.call.apply(e, [this].concat(i))), o.renderOptions = function () {
                return o.props.monthNames.map(function (e, n) {
                    return t.createElement("div", {
                        className: o.props.month === n ? "react-datepicker__month-option --selected_month" : "react-datepicker__month-option",
                        key: e,
                        ref: e,
                        onClick: o.onChange.bind(o, n)
                    }, o.props.month === n ? t.createElement("span", {
    ...
    var oe = function (e) {
        function n(r) {
            U(this, n);
            var o = Q(this, e.call(this, r));
            return o.renderOptions = function () {
                return o.state.monthYearsList.map(function (e) {
                    var n = e.valueOf(),
                        r = R(o.props.date, e) && F(o.props.date, e);
                    return t.createElement("div", {
                ...
                monthYearsList: function (e, t) {
                    for (var n = [], r = M(m(e)), o = M(m(t)); !Y(r, o);) n.push(m(r)), E(r, 1);
                    return n
        ...
        se = function (e) {
            function n() {
                ...
                return r = o = Q(this, e.call.apply(e, [this].concat(i))), o.state = {
                    ...
                    for (var e = M(P(o.props.minDate, o.props.locale)), n = M(P(o.props.maxDate, o.props.locale)), r = []; !Y(e, n);) {
                        var a = e.valueOf();
                        r.push(t.createElement("option", {
                            key: a,
                            value: a
                        }, D(e, o.props.dateFormat))), E(e, 1)
                    }
                    return r
                }, o.onSelectChange = function (e) {
                    o.onChange(e.target.value)
                    ...
                    var n = D(P(d(o.props.date), o.props.locale), o.props.dateFormat);
                    return t.createElement("div", {
                        key: "read",
                        style: {
                            visibility: e ? "visible" : "hidden"
                    ...
                    o.toggleDropdown();
                    var t = d(parseInt(e));
                    R(o.props.date, t) && F(o.props.date, t) || o.props.onChange(t)
                }, o.toggleDropdown = function () {
                    return o.setState({
                        dropdownVisible: !o.state.dropdownVisible
                    })
    ...
    var ie = function (e) {
        function n() {
            ...
            U(this, n);
            for (var s = arguments.length, i = Array(s), p = 0; s > p; p++) i[p] = arguments[p];
            return t = o = Q(this, e.call.apply(e, [this].concat(i))), o.handleClick = function (e) {
                ...
                return !o.props.inline && !o.isSameDay(o.props.selected) && o.isSameDay(o.props.preSelection)
            }, o.isDisabled = function () {
                return q(o.props.day, o.props)
                ...
                var e = o.props,
                    ...
                    s = e.startDate,
                    i = e.endDate;
                return !(!n && !r || !a || o.isDisabled()) && (n && i && a.isSameOrBefore(i) ? I(t, a, i) : !!(r && s && a.isSameOrAfter(s)) && I(t, s, a))
                ...
                return r("react-datepicker__day", t, "react-datepicker__day--" + function (e) {
    ...
    var pe = function (e) {
        function n() {
            var t, r, o;
            U(this, n);
            for (var a = arguments.length, s = Array(a), i = 0; a > i; i++) s[i] = arguments[i];
            return t = r = Q(this, e.call.apply(e, [this].concat(s))), r.handleClick = function (e) {
    ...
    pe.propTypes = {
        weekNumber: n.number.isRequired,
        onClick: n.func
    };
    var ce = function (e) {
        function n() {
            ...
            U(this, n);
            for (var s = arguments.length, i = Array(s), p = 0; s > p; p++) i[p] = arguments[p];
            return r = o = Q(this, e.call.apply(e, [this].concat(i))), o.handleDayClick = function (e, t) {
                ...
                "function" == typeof o.props.onWeekSelect && o.props.onWeekSelect(e, t, n)
            }, o.formatWeekNumber = function (e) {
                return o.props.formatWeekNumber ? o.props.formatWeekNumber(e) : function (e) {
                    return l(e, "week")
                }(e)
                ...
                if (o.props.showWeekNumber) {
                    var a = o.props.onWeekSelect ? o.handleWeekClick.bind(o, e, r) : void 0;
                    n.push(t.createElement(pe, {
                        key: "W",
                        weekNumber: r,
                        onClick: a
                    }))
    ...
    var le = 6,
        ue = function (e) {
            function n() {
                var o, a, s;
                U(this, n);
                for (var i = arguments.length, p = Array(i), c = 0; i > c; c++) p[c] = arguments[c];
                return o = a = Q(this, e.call.apply(e, [this].concat(p))), a.handleDayClick = function (e, t) {
                    ...
                    for (var e = [], n = a.props.fixedHeight, r = _(M(m(a.props.day))), o = 0, s = !1;;) {
                        if (e.push(t.createElement(ce, {
                                key: o,
                                day: r,
                                month: k(a.props.day),
                    ...
                    return r("react-datepicker__month", {
                        "react-datepicker__month--selecting-range": e.selectingDate && (e.selectsStart || e.selectsEnd)
                    })
                }, s = o, Q(a, s)
            }
            return J(n, e), n.prototype.render = function () {
    ...
    var de = function (e) {
        function n() {
            var r, o, a;
            U(this, n);
            for (var s = arguments.length, i = Array(s), c = 0; s > c; c++) i[c] = arguments[c];
            return r = o = Q(this, e.call.apply(e, [this].concat(i))), o.handleClick = function (e) {
                (o.props.minTime || o.props.maxTime) && V(e, o.props) || o.props.excludeTimes && B(e, o.props.excludeTimes) || o.props.includeTimes && !B(e, o.props.includeTimes) || o.props.onChange(e)
            }, o.liClasses = function (e, t, n) {
                var r = ["react-datepicker__time-list-item"];
                return t === v(e) && n === w(e) && r.push("react-datepicker__time-list-item--selected"), ((o.props.minTime || o.props.maxTime) && V(e, o.props) || o.props.excludeTimes && B(e, o.props.excludeTimes) || o.props.includeTimes && !B(e, o.props.includeTimes)) && r.push("react-datepicker__time-list-item--disabled"), o.props.injectTimes && (60 * v(e) + w(e)) % o.props.intervals != 0 && r.push("react-datepicker__time-list-item--injected"), r.join(" ")
            }, o.renderTimes = function () {
                for (var e = [], n = o.props.format ? o.props.format : "hh:mm A", r = o.props.intervals, a = o.props.selected ? o.props.selected : d(), s = v(a), i = w(a), c = function (e) {
                        return u(e, "day")
                    }(d()), l = 1440 / r, h = o.props.injectTimes && o.props.injectTimes.sort(function (e, t) {
                        return e - t
                    }), f = 0; l > f; f++) {
                    var y = N(m(c), f * r);
                    if (e.push(y), h) {
        ...
        return J(n, e), n.prototype.componentDidMount = function () {
            ...
            var e = this,
                n = null;
            return this.props.monthRef && (n = this.props.monthRef.clientHeight - 39), t.createElement("div", {
    ...
    var he = ["react-datepicker__year-select", "react-datepicker__month-select", "react-datepicker__month-year-select"],
        me = function () {
        ...
        fe = function (e) {
            function n(r) {
                U(this, n);
                var o = Q(this, e.call(this, r));
                return o.handleClickOutside = function (e) {
                    ...
                    o.props.onMonthChange && o.props.onMonthChange(e), o.props.adjustDateOnChange && (o.props.onSelect && o.props.onSelect(e), o.props.setOpen && o.props.setOpen(!0))
                }, o.handleMonthYearChange = function (e) {
                    o.handleYearChange(e), o.handleMonthChange(e)
                }, o.changeYear = function (e) {
                    o.setState({
                        date: b(m(o.state.date), e)
                    }, function () {
                        return o.handleYearChange(o.state.date)
                    })
                }, o.changeMonth = function (e) {
                    o.setState({
                        date: g(m(o.state.date), e)
                    }, function () {
                        return o.handleMonthChange(o.state.date)
                    })
                }, o.changeMonthYear = function (e) {
                    o.setState({
                        date: b(g(m(o.state.date), k(e)), C(e))
                    }, function () {
                        return o.handleMonthYearChange(o.state.date)
                    })
                }, o.header = function () {
                    var e = _(m(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : o.state.date)),
                        n = [];
                    return o.props.showWeekNumbers && n.push(t.createElement("div", {
                        key: "W",
                        className: "react-datepicker__day-name"
                    }, o.props.weekLabel || "#")), n.concat([0, 1, 2, 3, 4, 5, 6].map(function (n) {
                        var r = O(m(e), n),
                            a = function (e) {
                                return e.localeData()
                            }(r),
                    ...
                    return o.props.formatWeekDay ? function (e, t, n) {
                        return n(e.weekdays(t))
                    }(e, t, o.props.formatWeekDay) : o.props.useWeekdaysShort ? function (e, t) {
                    ...
                    if ((o.props.forceShowMonthNavigation || o.props.showDisabledMonthNavigation || !e) && !o.props.showTimeSelectOnly) {
                        var n = ["react-datepicker__navigation", "react-datepicker__navigation--previous"],
                            r = o.decreaseMonth;
                        return e && o.props.showDisabledMonthNavigation && (n.push("react-datepicker__navigation--previous--disabled"), r = null), t.createElement("button", {
                            type: "button",
                            className: n.join(" "),
                            onClick: r
                        })
                    ...
                    if ((o.props.forceShowMonthNavigation || o.props.showDisabledMonthNavigation || !e) && !o.props.showTimeSelectOnly) {
                        ...
                        o.props.showTimeSelect && n.push("react-datepicker__navigation--next--with-time"), o.props.todayButton && n.push("react-datepicker__navigation--next--with-today-button");
                        var r = o.increaseMonth;
                        return e && o.props.showDisabledMonthNavigation && (n.push("react-datepicker__navigation--next--disabled"), r = null), t.createElement("button", {
                            type: "button",
                            className: n.join(" "),
                            onClick: r
                        })
                    ...
                    return o.props.showYearDropdown && n.push("react-datepicker__current-month--hasYearDropdown"), o.props.showMonthDropdown && n.push("react-datepicker__current-month--hasMonthDropdown"), o.props.showMonthYearDropdown && n.push("react-datepicker__current-month--hasMonthYearDropdown"), t.createElement("div", {
                        className: n.join(" ")
                    }, D(e, o.props.dateFormat))
                }, o.renderYearDropdown = function () {
                    if (o.props.showYearDropdown && !(arguments.length > 0 && void 0 !== arguments[0] && arguments[0])) return t.createElement(ee, {
                    ...
                    if (o.props.showMonthDropdown && !(arguments.length > 0 && void 0 !== arguments[0] && arguments[0])) return t.createElement(re, {
                        dropdownMode: o.props.dropdownMode,
                    ...
                    if (o.props.showMonthYearDropdown && !(arguments.length > 0 && void 0 !== arguments[0] && arguments[0])) return t.createElement(se, {
                        dropdownMode: o.props.dropdownMode,
                        locale: o.props.locale,
                        dateFormat: o.props.dateFormat,
                    ...
                    if (o.props.todayButton && !o.props.showTimeSelectOnly) return t.createElement("div", {
                        ...
                        onClick: function (e) {
                            return o.props.onSelect(function (e) {
                                return u(e, "date")
                            }(h(o.props.utcOffset)), e)
                        }
                    }, o.props.todayButton)
                    ...
                    if (!o.props.showTimeSelectOnly) {
                        for (var e = [], n = 0; o.props.monthsShown > n; ++n) {
                            ...
                            e.push(t.createElement("div", {
                                ...
                                className: "react-datepicker__header__dropdown react-datepicker__header__dropdown--" + o.props.dropdownMode,
                    ...
                    if (o.props.showTimeSelect) return t.createElement(de, {
                        selected: o.props.selected,
            ...
            return J(n, e), G(n, null, [{
                ...
                e.preSelection && !W(e.preSelection, this.props.preSelection) ? this.setState({
                    date: this.localizeDate(e.preSelection)
                }) : e.openToDate && !W(e.openToDate, this.props.openToDate) && this.setState({
                    date: this.localizeDate(e.openToDate)
                })
            }, n.prototype.render = function () {
                return t.createElement(this.props.container || K, {
    ...
    var De = ["auto", "auto-left", "auto-right", "bottom", "bottom-end", "bottom-start", "left", "left-end", "left-start", "right", "right-end", "right-start", "top", "top-end", "top-start"],
        ye = function (e) {
            function n() {
                return U(this, n), Q(this, e.apply(this, arguments))
            }
            return J(n, e), n.prototype.render = function () {
                var e = this.props,
                    n = e.popperComponent,
                ...
                if (!e.hidePopper) {
                    ...
                    p = t.createElement(s.Popper, {
                        className: c,
                        modifiers: o,
                        placement: a
                    }, n)
                }
                return this.props.popperContainer && (p = t.createElement(this.props.popperContainer, {}, p)), t.createElement(s.Manager, null, t.createElement(s.Target, {
    ...
    var ge = "react-datepicker-ignore-onclickoutside",
        ...
        we = function (e) {
            function n(o) {
                ...
                return s.getPreSelection = function () {
                    return s.props.openToDate ? d(s.props.openToDate) : s.props.selectsEnd && s.props.startDate ? d(s.props.startDate) : s.props.selectsStart && s.props.endDate ? d(s.props.endDate) : h(s.props.utcOffset)
                    ...
                    s.state.preventFocus || (s.props.onFocus(e), s.props.preventOpenOnFocus || s.setOpen(!0)), s.setState({
                        focused: !0
                    })
                    ...
                    s.state.open && !s.props.withPortal ? s.deferFocusInput() : s.props.onBlur(e), s.setState({
                        focused: !1
                    })
                    ...
                    var r = t[0];
                    if (!s.props.onChangeRaw || (s.props.onChangeRaw.apply(s, t), "function" == typeof r.isDefaultPrevented && !r.isDefaultPrevented())) {
                        s.setState({
                    ...
                    }), s.setSelected(e, t), !s.props.shouldCloseOnSelect || s.props.showTimeSelect ? s.setPreSelection(e) : s.props.inline || s.setOpen(!1)
                }, s.setSelected = function (e, t, n) {
                    var r = e;
                    if (null === r || !q(r, s.props)) {
                        ...
                        s.props.onSelect(r, t), n || s.setState({
                            inputValue: null
                        })
                    }
                }, s.setPreSelection = function (e) {
                    (!(void 0 !== s.props.minDate && void 0 !== s.props.maxDate) || !e || I(e, s.props.minDate, s.props.maxDate)) && s.setState({
                        preSelection: e
                    })
                }, s.handleTimeChange = function (e) {
                    var t = y(m(s.props.selected ? s.props.selected : s.getPreSelection()), {
                        hour: v(e),
                        minute: w(e)
                    });
                    s.setState({
                        preSelection: t
                    }), s.props.onChange(t), s.setOpen(!1), s.setState({
                        inputValue: null
                    })
                    ...
                    if (s.state.open || s.props.inline || s.props.preventOpenOnFocus) {
                        ...
                        if ("Enter" === t) e.preventDefault(), f(s.state.preSelection) || function (e) {
                            return a.isDate(e)
                        }(s.state.preSelection) ? (s.handleSelect(n, e), !s.props.shouldCloseOnSelect && s.setPreSelection(n)) : s.setOpen(!1);
                            ...
                            switch (t) {
                                case "ArrowLeft":
                                    e.preventDefault(), r = function (e, t) {
                                        return c(e, t, "days")
                                    }(n, 1);
                                    break;
                                case "ArrowRight":
                            ...
                            s.props.adjustDateOnChange && s.setSelected(r), s.setPreSelection(r)
                        }
                    } else "Enter" !== t && "Escape" !== t && "Tab" !== t && s.onInputClick()
                    ...
                    return s.props.inline || s.state.open && !s.props.disabled ? t.createElement(be, {
                        ref: function (e) {
                            s.calendar = e
                        },
                    ...
                    var e, n, o = r(s.props.className, (e = {}, e[ge] = s.state.open, e)),
                        i = s.props.customInput || t.createElement("input", {
                            type: "text"
                        }),
                        p = s.props.customInputRef || "ref",
                        c = "string" == typeof s.props.value ? s.props.value : "string" == typeof s.state.inputValue ? s.state.inputValue : function (e, t) {
                            var n = t.dateFormat,
                                r = t.locale;
                            return e && e.clone().locale(r || a.locale()).format(Array.isArray(n) ? n[0] : n) || ""
                        }(s.props.selected, s.props);
                    return t.cloneElement(i, (n = {}, n[p] = function (e) {
                        s.input = e
                    }, n.value = c, n.onBlur = s.handleBlur, n.onChange = s.handleChange, n.onClick = s.onInputClick, n.onFocus = s.handleFocus, n.onKeyDown = s.onInputKeyDown, n.id = s.props.id, n.name = s.props.name, n.autoFocus = s.props.autoFocus, n.placeholder = s.props.placeholderText, n.disabled = s.props.disabled, n.autoComplete = s.props.autoComplete, n.className = o, n.title = s.props.title, n.readOnly = s.props.readOnly, n.required = s.props.required, n.tabIndex = s.props.tabIndex, n))
                }, s.renderClearButton = function () {
                    return s.props.isClearable && null != s.props.selected ? t.createElement("button", {
                        type: "button",
            ...
            return J(n, e), G(n, null, [{
                ...
                this.props.inline && function (e, t) {
                    return e && t ? k(e) !== k(t) || C(e) !== C(t) : e !== t
                }(this.props.selected, e.selected) && this.setPreSelection(e.selected), this.props.highlightDates !== e.highlightDates && this.setState({
                    highlightDates: H(e.highlightDates)
    ...
    }, e.default = we, e.CalendarContainer = K, Object.defineProperty(e, "__esModule", {
        value: !0
    })
});